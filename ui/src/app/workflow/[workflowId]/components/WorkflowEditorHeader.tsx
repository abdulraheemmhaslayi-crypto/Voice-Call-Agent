...
export const WorkflowEditorHeader = ({
    ...
    return (
        <div className="flex flex-col gap-3 px-4 py-3 bg-[#1a1a1a] border-b border-[#2a2a2a] md:flex-row md:items-center md:justify-between md:h-14">
            ...
            <div className="flex flex-1 flex-wrap items-center gap-2 md:gap-3">
                ...
                <div className="flex min-w-0 flex-1 items-center gap-2">
                    {rename.kind !== "display" ? (
                        ...
                        <>
                            <h1 className="text-base font-medium text-white truncate max-w-[12rem] md:max-w-md">
            ...
            <div className="flex flex-wrap items-center justify-end gap-2 md:gap-3">
                ...
                {isViewingHistoricalVersion && (
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-md border border-blue-500/30 bg-blue-500/10 text-xs md:text-sm">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 rounded-md border border-[#3a3a3a] hover:bg-[#2a2a2a] transition-colors cursor-pointer text-sm"
                >
                    <History className="w-4 h-4 text-gray-400" />
                    {activeVersionLabel && !isViewingHistoricalVersion && (
                        <span className="hidden sm:inline text-gray-300">{activeVersionLabel}</span>
                    )}
                </button>

                {/* Unsaved changes indicator (hidden when viewing history) */}
                {isDirty && !isViewingHistoricalVersion && (
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-md border border-yellow-500/30 bg-yellow-500/10 text-sm">
                        <div className="w-2 h-2 rounded-full bg-yellow-500" />
                        <span className="hidden sm:inline text-yellow-500">Unsaved changes</span>
                        <span className="sm:hidden text-yellow-500">Unsaved</span>
                    </div>
                )}
                ...
                {!isViewingHistoricalVersion && (
                    <Button
                        variant="outline"
                        className="hidden items-center gap-2 bg-transparent border-[#3a3a3a] hover:bg-[#2a2a2a] text-white sm:flex"
                ...
                <Button
                    variant="outline"
                    className="flex items-center gap-2 bg-transparent border-[#3a3a3a] hover:bg-[#2a2a2a] text-white px-3 sm:px-4"
