    ...
    try {
      ...
      if (response.data) {
        ...
        if (response.data.settings) {
          ...
          setEmbedMode(
            (settings.embedMode as "floating" | "inline" | "headless") ||
              "floating",
          );
          ...
          setCallToActionText(
            settings.callToActionText || "Click to start voice conversation",
          );
        }
  ...
  const handleSave = async () => {
    ...
    try {
      if (!isEnabled && embedToken) {
        ...
        const response =
          await createOrUpdateEmbedTokenApiV1WorkflowWorkflowIdEmbedTokenPost({
            path: { workflow_id: workflowId },
            body: {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Add &quot;{workflowName}&quot; to any website with a simple script
            tag.
          </DialogDescription>
        </DialogHeader>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-muted-foreground">
                          No UI — drive calls from your own buttons via the JS
                          API
                        </div>
                      </div>
                    </button>
                ...
                <div className="space-y-4">
                  ...
                  {embedMode !== "headless" && (
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="button-color" className="text-sm">
                          Button Color
                        </Label>
                        <div className="flex gap-2">
                          <Input
                  ...
                  {embedMode === "headless" ? null : embedMode ===
                    "floating" ? (
                    ...
                    <div className="space-y-3">
                      <div className="rounded-lg bg-muted/50 p-4">
                        ...
                        <ul className="text-sm space-y-2 text-muted-foreground">
                          ...
                          <li>
                            • The widget renders no UI — render your own
                            buttons.
                          </li>
                          <li>
                            • Call{" "}
                          ...
                          <li>
                            • Subscribe to{" "}
                            <code className="text-xs">onCallStart</code>,{" "}
                            <code className="text-xs">onCallEnd</code>,{" "}
                            <code className="text-xs">onStatusChange</code>,{" "}
                            <code className="text-xs">onError</code> to drive
                            your UI.
                          </li>
                          <li>
                            • <code className="text-xs">start()</code> must run
                            inside a user-gesture handler (click) so the browser
                      ...
                      <div className="rounded-lg bg-blue-50 dark:bg-blue-950/20 p-4 border border-blue-200 dark:border-blue-800">
                        ...
                        <p className="text-xs text-blue-900/80 dark:text-blue-100/80 mb-2">
                          Mirror the call status into a variable you control,
                          then render whatever UI you like from it. The status
                          values are <code className="text-xs">idle</code>,{" "}
                          <code className="text-xs">connecting</code>,{" "}
                          <code className="text-xs">connected</code>,{" "}
                          <code className="text-xs">failed</code>.
                        </p>
...
document.getElementById('talk-btn').addEventListener('click', () => {
  if (callStatus === 'connected' || callStatus === 'connecting') {
    ...
    window.DograhWidget.start();
                        ...
                        <p className="text-xs text-blue-900/80 dark:text-blue-100/80 mt-3 mb-2">
                          React:
                        </p>
                        <pre className="text-xs overflow-x-auto">
                    ...
                    <div className="space-y-3">
                      <div className="rounded-lg bg-muted/50 p-4">
                        ...
                        <ul className="text-sm space-y-2 text-muted-foreground">
                          <li>
                            • Add a div with
                            id=&quot;dograh-inline-container&quot; where you
                            want the widget
                          </li>
                          <li>
                          ...
                          <li>
                            • You have full control over the container&apos;s
                            styling
                          </li>
                          <li>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            copyToClipboard(embedToken.embed_script)
                          }
                        >
                          {copied ? (
                            <>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Add this script to your website&apos;s HTML to enable
                        the voice widget. Configuration changes will apply
                        automatically without re-embedding.
                      </p>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="rounded-lg border border-dashed bg-muted/30 px-4 py-8 text-center text-sm text-muted-foreground">
                        Click{" "}
                        <span className="font-medium">Save Configurations</span>{" "}
                        to generate your embed script.
                      </div>
                    </div>
                  </>
                )}
